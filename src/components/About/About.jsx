      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 place-items-center">
          ...
          <div
            ...
            className="before:block before:absolute before:-inset-1 before:-translate-x-6 before:bg-primary relative inline-block hover:before:-translate-x-2 before:duration-200"
          >
            <img
              src={AboutUs}
              alt="about-image"
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="" data-aos="fade-right" data-aos-delay="900">
                ...
                runners, helping them on their journey and creating a community.
                CRF is all about improving the runner experience, inspiring them
                to stay motivated and live a healthier life.
              </p>
            </div>
            <button
